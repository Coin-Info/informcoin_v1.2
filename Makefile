...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Jul 6 14:41:43 2018
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/Informcoin2/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Informcoin2/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Informcoin2/src/leveldb/libleveldb.a: FORCE
	cd C:/Informcoin2/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/Informcoin2/src/leveldb/libleveldb.a && ranlib C:/Informcoin2/src/leveldb/libmemenv.a
